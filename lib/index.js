...
function UPS(args) {
  var $scope = this,
    ...
    default_services = {
      ...
      'M7': 'UPS Expedited Mail Innovations'
    },
    return_services = {
  ...
  $scope.buildShipmentConfirmRequest = function(data, options) {
    ...
    if(data.service_code=='M4'){
      request['Shipment']['USPSEndorsement'] = data.uspsendorsement || '1',
      request['Shipment']['PackageID'] = data.packageid || 'aaabbbcccdddeee',
      request['Shipment']['SubClassification'] = data.subclassification || 'IR',
      request['Shipment']['CostCenter'] = data.cost_center || 'SOUNDBOTGROUPON'
    };
