...
if __name__ == '__main__':
    ...
    shipping_label_path = sys.argv[1]
    packing_slip_path = sys.argv[2]
    pdf_name = sys.argv[3]
    c = canvas.Canvas(pdf_name, pagesize=(792, 576))
    c.drawImage(shipping_label_path, 0, 0, 396, 576) 
    c.drawImage(packing_slip_path, 396, 0, 396, 576)
    c.save()
